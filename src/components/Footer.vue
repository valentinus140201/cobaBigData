...
<template>
	<footer class="dark:text-gray-100">
		<div class="grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4 dark:bg-gray-800 p-6" bis_skin_checked="1">
			<div class="flex flex-col space-y-4" bis_skin_checked="1">
				<h2 class="font-medium">Getting started</h2>
				<div class="flex flex-col space-y-2 text-sm dark:text-gray-400" bis_skin_checked="1">
		...
		<div class="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400" bis_skin_checked="1">
