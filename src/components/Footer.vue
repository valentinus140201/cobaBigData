...
<template>
	<footer>
		<div class="grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4 p-6 background-footer-atas" bis_skin_checked="1">
			<div class="flex flex-col space-y-4" bis_skin_checked="1">
				<h2 class="font-bold judul">Getting started</h2>
				<div class="flex flex-col space-y-2 text-sm warna-list" bis_skin_checked="1">
			...
			<div class="flex flex-col space-y-4" bis_skin_checked="1">
				<h2 class="font-bold judul">Core Concepts</h2>
				<div class="flex flex-col space-y-2 text-sm warna-list" bis_skin_checked="1">
			...
			<div class="flex flex-col space-y-4" bis_skin_checked="1">
				<h2 class="font-bold judul">Customization</h2>
				<div class="flex flex-col space-y-2 text-sm warna-list" bis_skin_checked="1">
			...
			<div class="flex flex-col space-y-4" bis_skin_checked="1">
				<h2 class="font-bold judul">Community</h2>
				<div class="flex flex-col space-y-2 text-sm warna-list" bis_skin_checked="1">
		...
		<div class="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row" bis_skin_checked="1">
			<div class="flex flex-col justify-center pt-6 lg:pt-0" bis_skin_checked="1">
				<div class="flex justify-center space-x-4" bis_skin_checked="1">
					<a rel="noopener noreferrer" href="#" title="Instagram" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-gray-500 dark:text-black">
					...
					<a rel="noopener noreferrer" href="#" title="Pinterest" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-gray-500 dark:text-black">
					...
					<a rel="noopener noreferrer" href="#" title="Twitter" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-gray-500 dark:text-black">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
					...
					<a rel="noopener noreferrer" href="#" title="Facebook" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-gray-500 dark:text-black">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
							<path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
						</svg>
					</a>
					<a rel="noopener noreferrer" href="#" title="Gmail" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-gray-500 dark:text-black">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
			...
			<ul class="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-end">
				<li><span class="dark:text-gray-400">© Copyright 2022. All Rights Reserved.</span></li>
			</ul>
		</div>
	</footer>
</template>